...
export default class FeedSourceTable extends Component {
  ...
  _isEditingFeedName = () => this.props.feedSources.some(function(feed){return feed.isCreating})

  _onHover = activeFeedSource => {
    if (!this._isEditingFeedName()) this.setState({activeFeedSource})
  }
